...
class historialahorroMapper extends QBMapper {
	...
	public function EnviarSolicitud(string $id_user, float $cantidad_solicitada, string $nota, string $cantidad_total): void {
		...
		$insert->insert($this->getTableName())
			->values(
				[
					'id_user' => $insert->createNamedParameter($id_user),
